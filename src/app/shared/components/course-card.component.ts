...
@Component({
  ...
  styles: [`
    ...
    .stats-footer {
      ...
      @include sm { gap: var(--spacing-2xl); justify-content: flex-start; }
    }

    .stat-item {
      display: flex; flex-direction: column; gap: var(--spacing-xs);
      @include sm { flex-direction: row; align-items: center; flex-shrink: 0; gap: var(--spacing-sm); }
  ...
  handleImageError(event: Event): void { (event.target as HTMLImageElement).style.display = 'none'; }
}
...
//             <div class="stat-text-group">
//               <p class="stat-label">Content</p>
//               <p class="stat-value">{{ course.totalLessons }} Lessons</p>
//             </div>
//           </div>
...
//             <div class="stat-text-group">
//               <p class="stat-label">Students</p>
//               <p class="stat-value">{{ course.totalEnrollments }} Enrolled</p>
//             </div>
//           </div>
...
//     .property-card {
//       /* Replaces: block p-4 rounded-lg shadow-indigo-100 */
//       display: block;
//       padding: var(--spacing-lg); 
//       background: var(--bg-secondary);
//       border-radius: var(--ui-border-radius-xl);
...
//       /* Premium Luminous Shadow */
//       box-shadow: 0 4px 20px -2px var(--theme-accent-focus), 
...
//     .image-wrapper {
//       /* Replaces: h-56 w-full rounded-md */
//       position: relative;
//       width: 100%;
//       height: 14rem; 
//       border-radius: var(--ui-border-radius-lg);
//       overflow: hidden;
//       margin-bottom: var(--spacing-md); /* Replaces mt-2 on the inner div */

//       .property-image {
//         /* Replaces: object-cover */
//         object-fit: cover;
...
//     /* Definition List Styles (Price & Title) */
//     dl {
//       margin: 0;
//     }
...
//     .title-text {
//       /* Replaces: font-medium text base */
//       font-family: var(--font-heading);
...
//     /* Footer Stats Row */
//     .stats-footer {
//       /* Replaces: mt-6 flex items-center gap-8 text-xs */
//       margin-top: auto; 
//       display: flex;
//       align-items: center;
...
//       @include sm {
//         gap: var(--spacing-2xl); /* gap-8 equivalent on larger screens */
//         justify-content: flex-start;
//       }
//     }

//     .stat-item {
//       /* Replaces: sm:inline-flex sm:shrink-0 sm:items-center sm:gap-2 */
//       display: flex;
//       flex-direction: column;
//       gap: var(--spacing-xs);
...
//       .stat-icon {
//         /* Replaces: size-4 text-indigo-700 */
//         width: 1.25rem;
//         height: 1.25rem;
//         color: var(--color-primary); 
//       }
...
//     'linear-gradient(135deg, var(--color-info-light) 0%, var(--color-info-dark) 100%)'
//   ];
...
//   getGradient(): string {
//     if (this.getValidImage()) return 'var(--bg-ternary)'; 
//     const index = this.course.title.length % this.gradients.length;
//     return this.gradients[index];
//   }
