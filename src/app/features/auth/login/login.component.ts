...
export class LoginComponent implements OnInit, OnDestroy {
  ...
  readonly examTags = [
    { label: 'UPSC IAS', hot: true },
    { label: 'SSC CGL', hot: true },
    { label: 'IBPS PO', hot: true },
    { label: 'RRB NTPC', hot: false },
    { label: 'State PSC', hot: false },
    { label: 'NDA / CDS', hot: false },
    { label: 'CUET', hot: true },
    { label: 'NEET / JEE', hot: false }
  ];

  readonly stats = [
    { num: '2.4', suffix: 'L+', label: 'Students Enrolled' },
    { num: '98',  suffix: '%',  label: 'Pass Rate 2024'  },
    { num: '850', suffix: '+',  label: 'Selections'       }
  ];
