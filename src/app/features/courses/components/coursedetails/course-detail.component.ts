  ...
  private loadCourse(identifier: string): void {
    ...
    request$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
      next: (res: any) => {
        ...
        // Set enrollment and ownership info
        ...
        // Set sections with lessons and expanded state
...
// import { takeUntilDestroyed } from '@angular/core/rxjs-interop';
// import { CommonModule, CurrencyPipe, DecimalPipe, NgClass, TitleCasePipe } from '@angular/common';
// import { ActivatedRoute, Router, RouterModule } from '@angular/router';
// import { FormBuilder, FormGroup, Validators, ReactiveFormsModule } from '@angular/forms';
...
//             setTimeout(() => this.router.navigate(['/learning', this.course()?.slug || courseId]), 1000);
//           } else {
